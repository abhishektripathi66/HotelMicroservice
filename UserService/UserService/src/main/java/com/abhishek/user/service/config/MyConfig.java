package com.abhishek.user.service.config;

import com.abhishek.user.service.config.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
    ...
    //declaring the oAuth2AuthorizedClientManager
    @Bean
